...
{
    public function detail(BadmintonField $field)
    {
    ...
    public function order(BadmintonField $field)
    {
        try {
    ...
    public function booking(BadmintonField $field, Request $request)
    {
        if (!$field->available()) {
            abort(404);
        }
    ...
    /**
     * Check Schedule Playing Badminton function
     *
     * @param BadmintonField $field
     * @return json
     */
    public function checkSchedule(BadmintonField $field)
    {
        if (!$field->available()) {
            abort(404);
        }
