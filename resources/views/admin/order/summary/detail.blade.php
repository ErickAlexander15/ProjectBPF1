@extends('layouts.app', [
'namePage' => 'List Order '.$order->badminton_field->name,
'class' => 'login-page sidebar-mini ',
'activePage' => 'list',
'backgroundImage' => asset('now') . "/img/bg14.jpg",
'parent' => 'order'
])
@section('title','Detail Order '.$order->badminton_field->name)
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <p class="text-muted">{{ $order->badminton_field->name }}</p>
                    </div>
                    <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="modal-body">
                <form action="" method="post" id="editForm">
                    ...
                    <div class="form-group">
                        ...
                        <p id="paymentMethod">Bank BCA</p>
                        <p><span id="paymentAccount">8230481432</span> a/n <span id="paymentAccountName">Erick Alexander</span></p>
                    </div>
                    <div class="form-group">
                        <p><a id="paymentProof" href="" target="_blank"><i class="fas fa-download"></i> Bukti Pembayaran</a></p>
                        <label>Tagihan</label>
                        <p class="h4 mt-n2 text-info" id="paymentTotal">Rp. 200.000</p>
                    </div>
                    <div class="form-group">
