                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                               <div class="form-group">
                                    ...
                                    <div class="row my-1">
                                        @foreach ($field->badminton_images as $img)
                                        <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Lebar (meter) <small
                                            class="text-danger">*</small></label>
                                    <input type="text" name="width" value="{{ old('width',$field->width) }}" placeholder="Lebar Lapangan" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Panjang (meter) <small class="text-danger">*</small></label>
                                    <input type="text" name="height" value="{{ old('height',$field->height) }}" placeholder="Panjang Lapangan" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
