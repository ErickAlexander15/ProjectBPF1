...
<div class="bg-white shadow-lg px-3 py-2 rounded">
    ...
    <div class="py-2">
        <div class="flex items-start mb-4 flex-col space-y-1">
            <p class="text-sm text-gray-600"><i class="fa-solid fa-court-sport"></i></i> Info Lapangan</p>
            <p class="text-sm text-gray-500">{{ $order->badminton_field->name }} ({{ $order->badminton_field->field_type->name }})</p>
        </div>
        <div class="flex items-start mb-4 flex-col space-y-1">
    ...
    <div class="card-transaction md:w-1/2 w-full">
        <div class="flex justify-start items-start flex-col">
            ...
            <span>
                ...
                @else
                    <p class="py-1 px-3 text-black text-xs font-medium {{ $transaction->order->status_transaction->color }} rounded-md">
        ...
        <div class="flex justify-start items-start flex-col">
            ...
            <p class="py-1 px-3 text-black text-xs  {{ $transaction->transaction_type->id == 2 ? 'bg-green-500' : 'bg-blue-500' }} rounded-md">
