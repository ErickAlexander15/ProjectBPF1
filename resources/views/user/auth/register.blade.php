    ...
    <div class=" bg-white shadow-xl px-4 py-4 rounded-lg w-full md:max-w-sm">
        ...
        <form action="{{route('register')}}" method="post" id="formRegister">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="bg-gray-100" name="name" placeholder="Nama Lengkap">
            </div>
            <div class="mb-3">
                <label>Email</label>
                <input type="email" class="bg-gray-100" name="email" placeholder="email@gmail.com">
            </div>
            <div class="mb-3">
                <label class="block">WhatsApp</label>
                <input type="tel" class="bg-gray-100" name="phone" inputmode="tel" placeholder="No Whatsapp">
            </div>
            <div class="mb-3">
