...
<div class="mt-20 h-full align-middle flex justify-center items-center flex-col">
    <div class=" bg-white shadow-xl px-4 py-4 rounded-lg w-full md:max-w-sm">
        ...
        <form action="{{route('login')}}" method="post" id="formLogin">
            ...
            <div class="mb-3">
                <label>Email</label>
                <input type="email" class="bg-gray-100" name="email" placeholder="Email Anda" value="user@angkasa.id">
            </div>
            <div class="mb-3">
                ...
                <input type="password" class="bg-gray-100" name="password" placeholder="Password" value="angkasa">
            </div>
            <div class="mb-3">
