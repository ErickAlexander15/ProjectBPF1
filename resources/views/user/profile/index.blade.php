...
<div class="px-2 py-4 bg-white rounded">
    <center>
    <div class="align-center rounded-full w-20 h-20 flex justify-center items-center overflow-hidden">
    ...
    <h2 class="text-2xl font-extrabold text-center">{{$user->name}}</h2>
    ...
    <div class="my-2 px-2 py-3 flex space-x-2 items-center">
